// Exported from:        http://Jans-MacBook-Pro.local:5516/#/templates/FolderSamplesAndTutorials-ReleaseTemplate_welcome/releasefile
// Release version:      9.7.0-SNAPSHOT
// Date created:         Wed Sep 30 17:46:19 CEST 2020
...
xlr {
  template('Welcome to Release!') {
      ...
      phase('Introduction') {
        ...
        tasks {
          manual('Welcome! Click me to get started') {
            description '## Welcome to Digital.ai Release!\n' +
                        '\n' +
          ...
          manual('Continue with the tour') {
            description 'We\'re now at the end of the general introduction for Digital.ai Release users.\n' +
                        '\n' +
    ...
    teams {
      team('Release Admin') {
        members 'admin'
        permissions 'release#edit_precondition', 'release#edit', 'release#lock_task', 'release#start', 'release#reassign_task', 'template#view', 'release#edit_failure_handler', 'release#edit_security', 'release#abort', 'release#view', 'release#edit_task'
      }
      team('Template Owner') {
        members 'admin'
        permissions 'template#edit', 'template#lock_task', 'template#view', 'template#edit_precondition', 'template#edit_security', 'template#create_release', 'template#edit_failure_handler'
      }
    }
